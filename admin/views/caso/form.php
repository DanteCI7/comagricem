...
<form method="POST" action="caso.php?action=<?php echo $action; ?>" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    <label class="form-label text-white">Caso de exito</label>
  ...
  <div class="mb-3">
    ...
    <div class="mb-3">
    <label class="form-label text-white">Resumen</label>
...
<label class="form-label text-white" for="imagen">Subir fotografía: </label>
        <input class="bg-dark text-white"  type="file" name="imagen"
            value='<?php echo isset($data[0]['imagen']) ? $data[0]['imagen'] : ''; ?>'/>
        

            <?php if ($action == 'edit'): ?>
            <label class="form-label text-white" for="imagen">Imagen actual:</label>
            <div class="imagenA">
        ...
        <?php endif; ?>
            ...
            <div class="mb-3">
<label class="form-label text-white">Esta activo?</label>
            </div>
            <div class="mb-3">
<input  type="radio" id="html" name="data[activo]" value="1">
<label class="text-white" for="html">True</label><br>
<input type="radio" id="css" name="data[activo]" value="0" checked>
<label class="text-white" for="css">False</label><br>
  </div>
