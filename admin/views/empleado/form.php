...
<div class="row">
    <div class="col-6">
        <form id="form" class="container-fluid "  method="POST" action="empleado.php?action=<?php echo $action; ?>"
            ...
            <div class="row">
                <div class="col-3">
                    <input required="required" type="text" class="form-control text-white bg-dark" id="nombre" name="data[nombre]"
            ...
            <div class="row">
                <div class="col-2">
                    <label for="primer_apellido" class="text-white">Apellido paterno:</label>
                </div>
            </div>
            <div class="row">
                <div class="col-3">
                    <input required="required" type="text" class="form-control text-white bg-dark" id="primer_apellido" name="data[primer_apellido]"
            ...
            <div class="row">
                <div class="col-2">
                    <label for="segundo_apellido" class="text-white">Apellido materno:</label>
                </div>
            </div>
            <div class="row">
                <div class="col-3">
                    <input required="required" type="text" class="form-control text-white bg-dark" id="segundo_apellido" name="data[segundo_apellido]"
            ...
            <div class="row">
                <div class="col-2">
                    <label for="fechaNacimiento" class="text-white">Fecha nacimiento:</label>
                </div>
            </div>
            <div class="row">

                <div class="col-3">
                    <input required="required" type="date" class="form-control text-white bg-dark" id="fechaNacimiento" name="data[fechaNacimiento]"
            ...
            <div class="row">
                <div class="col-2">
                    <label for="rfc" class="text-white">RFC:</label>
                </div>
            </div>
            <div class="row">
                <div class="col-3">
                    <input required="required" type="text" class="form-control text-white bg-dark" id="rfc" name="data[rfc]"
            ...
            <div class="row">
                <div class="col-2">
                    <label for="curp" class="text-white">CURP:</label>
                </div>
            </div>
            <div class="row">
                <div class="col-3">
                    <input required="required" type="text" class="form-control text-white bg-dark" id="curp" name="data[curp]"
            ...
            <div class="row">
                <div class="col-3">
                    <select class="form-control text-white bg-dark " placeholder=".form-control-lg" name="data[id_departamento]" required="required">
                        <?php
                        $selected = " ";
