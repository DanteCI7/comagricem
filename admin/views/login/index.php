      ...
      <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
        <form method="POST" action="login.php?action=login">
          ...
          <div class="form-outline mb-4">
            ...
            <label style="color:#fff" class="form-label" for="form1Example13">Correo</label>
          </div>

          <!-- Password input -->
          <div class="form-outline mb-4">
            <input type="password" id="form1Example23" name="contrasena" class="form-control form-control-lg" />
            <label style="color:#fff" class="form-label" for="form1Example23">Contrasena</label>
          </div>

          <div class="d-flex justify-content-around align-items-center mb-4">
            <a href="login.php?action=forgot" class="link-info">Olvide mi contrasena</a>
          </div>
