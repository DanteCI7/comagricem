...
<form method="POST" action="departamento.php?action=<?php echo $action; ?>">
  <div class="mb-3">
    <label class="form-label text-black">Nombre del Departamento</label>
    <input type="text" name="data[departamento]" class="form-control text-white bg-dark" placeholder="Departamento"
