<div class="container mt-5 card bg-transparent">
    <h1>
    ...
    <form class="container-fluid" method="POST" action="rol.php?action=<?php echo ($action); ?>"
        ...
        <div class="row mt-5 mb-5">
            <div class="col-5">
                ...
                <div class="row">
                    <div class="col-2">
                        <input required="required" type="text" class="bg-transparent text-white" id="rol" name="data[rol]"
                    ...
                    <div class="form-check form-switch">
                        ...
                        <?php else: ?>
                            ...
                            <input class="form-check-input" type="checkbox" role="switch"
                                id="<?php echo $privilegio['id_privilegio'] ?>" name="check_lista[]"
                                value="<?php echo $privilegio['id_privilegio'] ?>">
                            <label class="form-check-label text-white" for="<?php echo $privilegio['id_privilegio'] ?>"><?php echo $privilegio['privilegio'] ?></label>
                        <?php endif; ?>
                    </div>
                <?php endforeach ?>
            </div>
