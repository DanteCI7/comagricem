...
class Sistema
{
    ...
    public function uploadfile($tipo, $ruta, $archivo)
    {
        ...
        "application/vnd.ms-excel", "application/pdf", "image/jpeg", "image/jpg", "image/gif", "image/png");
    ...
    public function forgot($destinatario, $token)
    {
        if ($this->validateEmail($destinatario)) {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = '19030313@itcelaya.edu.mx';
            $mail->Password = 'goanopoeamfmrncx';
            $mail->setFrom('19030313@itcelaya.edu.mx', 'sadlf');
            $mail->addAddress($destinatario, 'Sistema Constructora');
            $mail->Subject = 'Recuperacion de contraseña';
            $mensaje = "
            Estimado usuario para poder recuperar su contraseña solo debe seguir las instrucciones<br><br>
            <a href=\"http://localhost/comagricen/admin/login.php?action=recovery&token=$token&correo=$destinatario\">Presione aqui para recuperar la contraseña.</a> <br><br>
            Comagricen a sus ordenes.
            ";
